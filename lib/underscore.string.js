...
(function(){
    ...
    var _s = {
        ...
        eachChar: function(str, callback) {
            _(str.split('')).each(function(char) { callback.call(this, char) });
        },

        eachLine: function(str, callback) {
            _(str.split("\n")).each(function(line) { callback.call(this, line) });
        },

        eachWord: function(str, callback, delimiter) {
            delimiter = delimiter || ' ';
            _(str.split(delimiter)).each(function(word) { callback.call(this, word) })
        },
